...
execute_singleplayer_attack(Personaje, Enemigo, Resultado):-
    ...
    (Fuerza >= Vida
    ->  atomic_list_concat([Personaje, 'derrota a', Enemigo,
                            'con', Fuerza, 'de dano vs', Vida, 'de vida - Victoria.'], ' ', Resultado)
    ;   atomic_list_concat([Personaje, 'ataca a', Enemigo,
                            'con', Fuerza, 'de dano vs', Vida, 'de vida - Derrota.'], ' ', Resultado)
    ).
...
excecute_grupal_attack(P1, P2, Enemigo, Resultado) :-
    ...
    enemigo(Enemigo, Vida),
    (FuerzaTotal >= Vida
    ->  atomic_list_concat([P1, 'y', P2, 'derrotan a', Enemigo,
                            'con', FuerzaTotal, 'de dano vs', Vida, 'de vida - Victoria!'], ' ', Resultado)
    ;   atomic_list_concat([P1, 'y', P2, 'atacan a', Enemigo,
                            'con', FuerzaTotal, 'de dano vs', Vida, 'de vida - Derrota.'], ' ', Resultado)
    ).